...
namespace EXERCICIO01 // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("EXERCICIOS - LISTA 01");
            Console.WriteLine("1 - Crie um programa que calcule a média ((nota1 + nota2 + nota3 / 3)) ");
            Console.WriteLine("2 - Crie um programa que calcule a área (lado1 * lado2) ");
            Console.WriteLine("3 - Crie um programa que calcule o volume (largura * altura * profundidade) ");
            ...
            Console.WriteLine("6 - Crie um programa que calcule a velocidade média de uma viagem (distancia (km) / tempo (h)) ");
            ...
            Console.WriteLine("9 - Crie um programa que compare dois valores Strings ");
            Console.WriteLine("10 - Crie um programa que tenha uma variável com ponto em String e converta seu valor para inteiro ");
            Console.WriteLine("11 - Crie um programa que receba o salário e diga o valor de imposto de renda");
